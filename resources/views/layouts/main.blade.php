...
<body class="index-page">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
         ...
         <li><a href="#lapangan">Lapangan </a></li>
          ...
          <li><a href="#about">Main bareng</a></li>
          <li><a href="#services">Sparing</a></li>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <!-- Role Section -->
    <section id="role" class="role section">
        <!-- Section Title -->
        <div class="container section-title" data-aos="fade-up">
            <h2>Role</h2>
            <p>Role yang memiliki hak akses</p>
        </div><!-- End Section Title -->

        <div class="container">
            <div class="row gy-4">

                <!-- Tampilkan Role yang Sudah Dibuat -->
                ...
                <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <ul>
                        @foreach ($users as $user)
                            ...
                            <a href="3" class="btn btn-warning btn-sm">Edit</a>
                        @endforeach
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-lg-6 order-2 order-lg-1 content" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <li>
                        <strong>{{ $lapangan->name }}</strong> - {{ $lapangan->location }}
                        - Rp {{ number_format($lapangan->price_per_hour, 2, ',', '.') }} per Jam
                        @if ($lapangan->image)
                            <br>
                            <img src="{{ asset('storage/' . $lapangan->image) }}" alt="Lapangan Image" width="100" />
                        @endif
                            <br>
                ...
                <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <form action="{{ route('lapangan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="price_per_hour" id="price_per_hour" class="form-control" required>
                        </div>
                        <div class="form-group mt-3">
...
<section id="lapangan" class="lapangan section">
    <div class="container">
        <div class="row gy-4">
            <!-- Loop untuk menampilkan semua lapangan -->
            @foreach ($lapangans as $lapangan)
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                    <div class="card shadow-sm" style="border-radius: 15px; overflow: hidden;">
                        <!-- Gambar Lapangan -->
                        @if ($lapangan->image)
                            <img src="{{ asset('storage/' . $lapangan->image) }}" class="card-img-top" alt="{{ $lapangan->name }}" style="object-fit: cover; height: 200px;">
                        @else
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title"><strong>{{ $lapangan->name }}</strong></h5>

                            <!-- Rating dan Lokasi -->
                            <p class="card-text mb-1">
                                ⭐ 5.00 • {{ $lapangan->location }}
                            </p>

                            <!-- Kategori -->
                            <p class="text-muted mb-2">
                                <i class="bi bi-stopwatch"></i> Futsal
                            </p>

                            <!-- Harga -->
                            <p class="mb-0">
                                Mulai <strong class="text-success">Rp{{ number_format($lapangan->price_per_hour, 0, ',', '.') }}</strong> /sesi
                            </p>

                            <!-- Tombol Booking -->
                            <div class="mt-3">
                                <a href="{{ route('bookings.create', ['lapangan_id' => $lapangan->id]) }}" class="btn btn-primary btn-sm">
                                    Booking Sekarang
                                </a>
                            </div>
                        </div>
